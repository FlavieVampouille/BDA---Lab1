...
public class round3 extends Configured implements Tool {
	...
	public static class Map extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			String output = ID + "/" + wordCount + "/" + wordsPerDoc;
	...
	public static HashMap<String,Integer> Docs_Per_Word = new HashMap<String, Integer>();
	...
	public static class Reduce extends Reducer<Text, Text, Text, Text> {
		...
		public void reduce(Text key, Iterable<Text> value, Context context) 
			...
			for (Text val : value){
				...
				double docsPerWord = (double) Docs_Per_Word.get(word);
